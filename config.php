...
return [
    ...
    */
    ...
    'domains' => [
        ...
        'xpsystems.eu' => [
            'from' => '2025-01-15', 'to' => '2030-01-15', 'status' => 'active',
            'description' => null, 'note' => null, 'github_url' => null,
        ...
        'xpsys.de' => [
            'from' => '2025-01-17', 'to' => '2027-01-17', 'status' => 'active',
            'description' => null, 'note' => null, 'github_url' => null,
            'owner' => null, 'github_owner' => null, 'subdomains' => null,
        ],
        'xfolio.eu' => [
        ...
        'eudomains.eu' => [
            'from' => '2025-02-11', 'to' => '2027-02-11', 'status' => 'active',
        ...
        'bank-of-germany.de' => [
            'from' => '2025-02-17', 'to' => '2028-02-17', 'status' => 'active',
            'description' => null, 'note' => null, 'github_url' => null,
            'owner' => null, 'github_owner' => null, 'subdomains' => null,
        ],
        'schulchat-rlp.de' => [
        ...
        'eushare.eu' => [
            'from' => '2025-03-08', 'to' => '2026-03-08', 'status' => 'active',
            'description' => null, 'note' => null, 'github_url' => null,
            'owner' => null, 'github_owner' => null, 'subdomains' => null,
        ],
        'ptero01.eu' => [
        ...
        '2note.eu' => [
            'from' => '2025-03-11', 'to' => '2026-03-11', 'status' => 'active',
            'description' => null, 'note' => null, 'github_url' => null,
            'owner' => null, 'github_owner' => null, 'subdomains' => null,
        ],
        'burgermc.de' => [
        ...
        'fternis.de' => [
            'from' => '2025-03-21', 'to' => '2028-03-21', 'status' => 'active',
            'description' => 'Short personal domain.',
            'note' => null, 'github_url' => null,
            'owner' => null, 'github_owner' => null, 'subdomains' => null,
        ],
        'bildungsbereich-rlp.de' => [
            'from' => '2025-04-16', 'to' => '2026-04-16', 'status' => 'active',
            'description' => null, 'note' => null, 'github_url' => null,
            'owner' => null, 'github_owner' => null, 'subdomains' => null,
        ],
        'xp-ad.de' => [
            'from' => '2025-04-23', 'to' => '2026-04-23', 'status' => 'active',
            'description' => null, 'note' => null, 'github_url' => null,
            'owner' => null, 'github_owner' => null, 'subdomains' => null,
        ],
        'laravel-tutorial.eu' => [
            'from' => '2025-04-25', 'to' => '2026-04-25', 'status' => 'active',
            'description' => null, 'note' => null, 'github_url' => null,
            'owner' => null, 'github_owner' => null, 'subdomains' => null,
        ],
        'gehirn-weg.de' => [
            'from' => '2025-05-13', 'to' => '2026-05-13', 'status' => 'active',
            'description' => null, 'note' => null, 'github_url' => null,
            'owner' => null, 'github_owner' => null, 'subdomains' => null,
        ],
        'staatliches-heinrich-heine-gymnasium-kaiserslautern.de' => [
            'from' => '2025-05-15', 'to' => '2026-05-15', 'status' => 'active',
            'description' => null, 'note' => null, 'github_url' => null,
            'owner' => null, 'github_owner' => null, 'subdomains' => null,
        ],
        'spielefrei.de' => [
            'from' => '2025-05-22', 'to' => '2026-05-22', 'status' => 'active',
            'description' => null, 'note' => null, 'github_url' => null,
            'owner' => null, 'github_owner' => null, 'subdomains' => null,
        ],
        'yourlink.app' => [
            'from' => '2025-05-27', 'to' => '2026-05-27', 'status' => 'active',
            'description' => null, 'note' => null, 'github_url' => null,
            'owner' => null, 'github_owner' => null, 'subdomains' => null,
        ],
        'mcserver.lol' => [
        ...
        'gimy.site' => [
            'from' => '2025-07-08', 'to' => '2026-07-08', 'status' => 'active',
        ...
        'urlk.app' => [
            'from' => '2025-07-13', 'to' => '2026-07-13', 'status' => 'active',
            'description' => null, 'note' => null, 'github_url' => null,
            'owner' => null, 'github_owner' => null, 'subdomains' => null,
        ],
        'twch.pics' => [
            'from' => '2025-07-26', 'to' => '2026-07-26', 'status' => 'active',
            'description' => null, 'note' => null, 'github_url' => null,
            'owner' => null, 'github_owner' => null, 'subdomains' => null,
        ],
        'fabianternis.dev' => [
            'from' => '2025-07-29', 'to' => '2027-07-29', 'status' => 'active',
        ...
        'fabianternis.de' => [
            'from' => '2025-08-07', 'to' => '2031-08-07', 'status' => 'active',
        ...
        'pleasehireme.eu' => [
            'from' => '2025-08-17', 'to' => '2027-08-17', 'status' => 'active',
            'description' => null, 'note' => null, 'github_url' => null,
            'owner' => null, 'github_owner' => null, 'subdomains' => null,
        ],
        'getmy.name' => [
            'from' => '2025-08-19', 'to' => '2027-08-19', 'status' => 'active',
            'description' => null, 'note' => null, 'github_url' => null,
            'owner' => null, 'github_owner' => null, 'subdomains' => null,
        ],
        'getmy.blog' => [
            'from' => '2025-09-09', 'to' => '2026-09-09', 'status' => 'active',
            'description' => null, 'note' => null, 'github_url' => null,
            'owner' => null, 'github_owner' => null, 'subdomains' => null,
        ],
        'fabian-ternis.de' => [
            'from' => '2025-09-16', 'to' => '2026-09-16', 'status' => 'active',
            'description' => 'Personal domain.',
            'note' => null, 'github_url' => null,
            'owner' => null, 'github_owner' => null, 'subdomains' => null,
        ],
        'mysocials.me' => [
            'from' => '2025-10-07', 'to' => '2026-10-07', 'status' => 'active',
            'description' => null, 'note' => null, 'github_url' => null,
            'owner' => null, 'github_owner' => null, 'subdomains' => null,
        ],
        'getsocials.link' => [
            'from' => '2025-10-08', 'to' => '2026-10-08', 'status' => 'active',
            'description' => null, 'note' => null, 'github_url' => null,
            'owner' => null, 'github_owner' => null, 'subdomains' => null,
        ],
        'linkmy.name' => [
        ...
        'kaufenhof.de' => [
            'from' => '2025-10-02', 'to' => '2026-10-02', 'status' => 'active',
        ...
        'woistdasdrachenei.de' => [
            'from' => '2025-11-11', 'to' => '2026-11-11', 'status' => 'active',
            'description' => null, 'note' => null, 'github_url' => null,
            'owner' => null, 'github_owner' => null, 'subdomains' => null,
        ],
        'ivoternis.de' => [
        ...
        'heimatverein-floersheim-dalsheim.de' => [
            'from' => '2025-11-28', 'to' => '2026-11-28', 'status' => 'active',
            'description' => null, 'note' => null, 'github_url' => null,
            'owner' => null, 'github_owner' => null, 'subdomains' => null,
        ],
        '192-168-0-1.de' => [
            'from' => '2025-11-30', 'to' => '2026-11-30', 'status' => 'active',
            'description' => null,
        ...
        'sandbox-api.de' => [
            'from' => '2026-01-05', 'to' => '2027-01-05', 'status' => 'active',
            'description' => null, 'note' => null, 'github_url' => null,
            'owner' => null, 'github_owner' => null, 'subdomains' => null,
        ],
        'api-sandbox.de' => [
        ...
        'hhg-kl.eu' => [
            'from' => '2026-01-12', 'to' => '2027-01-12', 'status' => 'active',
            'description' => null, 'note' => null, 'github_url' => null,
            'owner' => null, 'github_owner' => null, 'subdomains' => null,
        ],
        'mail-free.eu' => [
        ...
        'ternis.eu' => [
            'from' => '2026-01-21', 'to' => '2029-01-21', 'status' => 'active',
            'description' => null, 'note' => null,
            'github_url'   => null,
            'owner'        => null, 'github_owner' => null,
            'subdomains' => [
        ...
        'xpsystems.de' => [
            'from' => '2026-02-03', 'to' => '2027-02-03', 'status' => 'active',
            'description' => null, 'note' => null,
        ...
        'eu-data.org' => [
            'from' => '2026-02-16', 'to' => '2027-02-16', 'status' => 'active',
            'description' => null, 'note' => null,
            'github_url'   => 'https://github.com/eu-data-org',
            'owner'        => null, 'github_owner' => null, 'subdomains' => null,
        ],
        'eu-search.org' => [
            'from' => '2026-02-17', 'to' => '2027-02-17', 'status' => 'active',
            'description' => null, 'note' => null,
        ...
        'pleasehireme.de' => [
            'from' => '2026-03-03', 'to' => '2027-03-03', 'status' => 'active',
            'description' => null, 'note' => null, 'github_url' => null,
            'owner' => null, 'github_owner' => null, 'subdomains' => null,
        ],
    ],
